...
INSERT INTO `users` (`id`, `id_company`, `id_department`, `first_name`, `last_name`, `nif`, `email`, `username`, `password`, `created_on`, `last_login`, `salt`, `forgotten_password_code`, `forgotten_password_time`, `remember_code`, `activation_code`, `ip_address`, `active`) VALUES
	(00004, 001, 008, 'Pepe', 'Gáfez', '11223344B', 'pepe@company.com', 'pepe', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', 1435221351, 1442995180, NULL, 'vFilAz41e5duH1v-6usdaO37bccdbab8d44258e6', 1435744101, 'h9TFdlu8F8vYlHQZhMZfle', NULL, NULL, 1),
